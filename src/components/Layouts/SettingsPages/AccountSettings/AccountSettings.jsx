      ...
      <div className="container-fluid home-layout-div">
        ...
        <div className="row">
          <div className="col-md-3">
            <div className="setting-options">
              <ul>
                ...
                <li>
                  <a href="/user/notification_settings">
          ...
          <div className="col-md-9">
            <div className="row">
              <div className="account-settings-contents-div">
                ...
                <div className="account-settings-contents">
                  <form>
                    ...
                    <div className="acoount-settings-inputs">
                    ...
                    <div className="account-settings-submit-btn">
