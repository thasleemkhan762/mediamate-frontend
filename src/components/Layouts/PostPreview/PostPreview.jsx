...
function PostPreview({ closePreviewModal, previewData  }) {
 

  return (
    <>
      <div className="preview-extra-div">
        <div className="row preview-row">
          <div className="col-sm-12 preview-post-div">
            ...
            <div className="col-sm-10">
              ...
              <div className="home-post-media">
                {previewData.file &&
                previewData.file.startsWith("data:image/") ? (
                  <img
                  ...
                  <video controls className="post-preview-video">
                    <source src={previewData.file} type="video/mp4" />
          ...
          <div className="preview-close-btn">
            <div>
              <button onClick={closePreviewModal} className="btn btn-primary">
                close preview
              </button>
            </div>
          </div>
